...
CREATE TABLE IF NOT EXISTS `Quizmaster`.`Course` (
  ...
  INDEX `verzinzelf3_idx` (`idCoordinator` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `Quizmaster`.`Quiz` (
  ...
  CONSTRAINT `verzinzelf1`
    ...
    REFERENCES `Quizmaster`.`Course` (`nameCourse`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Quizmaster`.`Group` (
  ...
  PRIMARY KEY (`idGroep`),
  INDEX `verzinzelf2_idx` (`idTeacher` ASC) VISIBLE,
