...
// Launcher for various things, including my

// Launcherpart 1: Reads CSV data into a list, and creating a list of Group objects,
// which are then stored in the database

// Launcherpart 2: performs JSON-related operations using Gson, executes operations on a CouchDB database,
